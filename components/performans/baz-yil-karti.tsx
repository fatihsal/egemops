    ...
    <Card className="h-full">
      ...
      <CardContent className="flex flex-1 flex-col justify-center">
        <div className="grid grid-cols-2 gap-x-4 gap-y-5 sm:grid-cols-4">
          <div>
            <p className="text-[11px] text-muted-foreground">{t("Baz Yıl")}</p>
            <p className="mt-1 font-heading text-2xl font-bold tracking-tight">{b.bazYil}</p>
          </div>
          <div>
            <p className="text-[11px] text-muted-foreground">{t("Baz EnPI")}</p>
            <p className="mt-1 font-heading text-2xl font-bold tracking-tight tabular-nums">{b.bazEnPI}</p>
          </div>
          <div>
            <p className="text-[11px] text-muted-foreground">{t("2026 EnPI")}</p>
          ...
          <div>
            <p className="text-[11px] text-muted-foreground">{t("İyileşme")}</p>
