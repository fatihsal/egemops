...
const IKON: Record<string, { ikon: string; sinif: string }> = {
  toplam: { ikon: "solar:fire-bold-duotone", sinif: "bg-violet-50 text-violet-600 dark:bg-violet-950 dark:text-violet-300" },
  ...
  ortalama: { ikon: "solar:chart-2-bold-duotone", sinif: "bg-teal-50 text-teal-600 dark:bg-teal-950 dark:text-teal-300" },
  enYuksek: { ikon: "solar:graph-up-bold-duotone", sinif: "bg-violet-50 text-violet-600 dark:bg-violet-950 dark:text-violet-300" },
  enDusuk: { ikon: "solar:graph-down-bold-duotone", sinif: "bg-blue-50 text-blue-600 dark:bg-blue-950 dark:text-blue-300" },
  yogunluk: { ikon: "solar:speedometer-max-bold-duotone", sinif: "bg-purple-50 text-purple-600 dark:bg-purple-950 dark:text-purple-300" },
};
...
export function DogalgazKpiKartlari() {
