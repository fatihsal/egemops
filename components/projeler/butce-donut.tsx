...
export function ProjeButceDonut() {
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        <h3 className="font-heading text-base font-medium">Proje Bütçe Durumu</h3>
      </CardHeader>
