    ...
    <Card className="h-full">
      <CardHeader>
        <h3 className="font-heading text-base font-medium">
          Yıllık Potansiyel Tasarruf <span className="text-sm font-normal text-muted-foreground">(TEP)</span>
        </h3>
      </CardHeader>
          ...
          <div className="min-h-[260px] w-full flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.kaynakTasarruf} margin={{ left: 4, right: 8, top: 28, bottom: 16 }}>
                ...
                <XAxis dataKey="etiket" tickLine={false} axisLine={false} fontSize={12} stroke="var(--muted-foreground)" label={{ value: "Enerji Kaynağı", position: "insideBottom", offset: -12, fontSize: 11, fill: "var(--muted-foreground)" }} />
                ...
                <Tooltip
                  ...
                  formatter={(value) => [`${sayiOndalik(Number(value))} TEP/yıl`, "Potansiyel Tasarruf"]}
                />
