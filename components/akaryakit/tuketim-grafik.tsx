...
const BIRIM = {
  Litre: { faktor: 1, eksen: (n: number) => sayiKisa(n), tooltip: (n: number) => `${sayi(n)} Litre` },
  TEP: { faktor: AKARYAKIT_TEP_FAKTOR, eksen: (n: number) => sayiOndalik(n), tooltip: (n: number) => `${sayiOndalik(n)} TEP` },
} as const;
