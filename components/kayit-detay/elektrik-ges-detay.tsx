      ...
      <CardContent className="space-y-5">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-2.5">
            <Satir etiket={t("Şebeke Elektrik Tüketimi")} deger={`${sayi2(kayit.sebekeElektrik)} kWh`} />
            <Satir etiket={t("GES Toplam Üretimi")} deger={`${sayi2(kayit.gesUretim)} kWh`} />
            <Satir etiket={t("GES Öz Tüketimi")} deger={`${sayi2(kayit.gesOzTuketim)} kWh`} />
            <Satir etiket={t("Şebekeye Verilen Enerji")} deger={`${sayi2(kayit.sebekeyeVerilen)} kWh`} />
            <div className="border-t pt-2.5">
              <Satir etiket={t("Toplam Fabrika Elektrik Tüketimi")} deger={`${sayi2(kayit.elektrik)} kWh`} />
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-1">
            ...
            <div className="text-xs text-muted-foreground">{t("GES Katkı Oranı")}</div>
          </div>

          {/* Aylık trend */}
          <div className="flex flex-col justify-center sm:col-span-2 lg:col-span-1">
            <div className="mb-1 text-xs text-muted-foreground">
              {t("Aylık GES Katkı Oranı (%)")}
            </div>
        ...
        <div className="grid grid-cols-2 gap-4 border-t pt-4">
          <div>
            <div className="text-xs text-muted-foreground">{t("Toplam Elektrik TEP")}</div>
          ...
          <div>
            <div className="text-xs text-muted-foreground">{t("GES Karşılama Oranı")}</div>
