        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              <TableHead>{t("Gösterge")}</TableHead>
              <TableHead className="text-right">{kayit.oncekiDonem ? t(kayit.oncekiDonem) : "—"}</TableHead>
              <TableHead className="text-right">{t(kayit.donem)}</TableHead>
              <TableHead className="text-right">{t("Değişim")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {satirlar.map((s) => (
