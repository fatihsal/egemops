...
export function BelgeKategorileri() {
  ...
  return (
    <Card>
      <CardHeader>
        <h3 className="font-heading text-base font-medium">Kategoriler</h3>
      </CardHeader>
      <CardContent>
        {isLoading || !data ? (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-2">
                      <p className="truncate text-sm font-medium">{k.baslik}</p>
                    ...
                    <p className="mt-0.5 line-clamp-2 text-xs text-muted-foreground">{k.aciklama}</p>
                    <p className="mt-2 flex items-center gap-2 text-xs text-muted-foreground">
                      <span className="font-semibold text-foreground">{k.adet}</span> belge
